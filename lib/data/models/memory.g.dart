...
extension GetMemoryCollection on Isar {
  IsarCollection<Memory> get memories => this.collection();
}
...
const MemorySchema = CollectionSchema(
  ...
  links: {
    r'location': LinkSchema(
      id: 8798576791394881045,
      name: r'location',
      target: r'Location',
      single: true,
    ),
    r'tags': LinkSchema(
      id: -7122061592421020064,
      name: r'tags',
      target: r'Tag',
      single: false,
    )
...
List<IsarLinkBase<dynamic>> _memoryGetLinks(Memory object) {
  return [object.location, object.tags];
}
...
extension MemoryQueryFilter on QueryBuilder<Memory, Memory, QFilterCondition> {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesEqualTo(
    String value, {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'notes',
        value: '',
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> notesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'notes',
        value: '',
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'photoPaths',
        0,
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'photoPaths',
        0,
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> photoPathsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MemoryQueryLinks on QueryBuilder<Memory, Memory, QFilterCondition> {
  QueryBuilder<Memory, Memory, QAfterFilterCondition> location(
  ...
  QueryBuilder<Memory, Memory, QAfterFilterCondition> locationIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'location', 0, true, 0, true);
    });
  }

  QueryBuilder<Memory, Memory, QAfterFilterCondition> tags(FilterQuery<Tag> q) {
    return QueryBuilder.apply(this, (query) {
...
extension MemoryQuerySortBy on QueryBuilder<Memory, Memory, QSortBy> {
  ...
  QueryBuilder<Memory, Memory, QAfterSortBy> sortByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<Memory, Memory, QAfterSortBy> sortByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MemoryQuerySortThenBy on QueryBuilder<Memory, Memory, QSortThenBy> {
  ...
  QueryBuilder<Memory, Memory, QAfterSortBy> thenByNotes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.asc);
    });
  }

  QueryBuilder<Memory, Memory, QAfterSortBy> thenByNotesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'notes', Sort.desc);
    });
  }
...
extension MemoryQueryWhereDistinct on QueryBuilder<Memory, Memory, QDistinct> {
  ...
  QueryBuilder<Memory, Memory, QDistinct> distinctByNotes(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Memory, Memory, QDistinct> distinctByPhotoPaths() {
    return QueryBuilder.apply(this, (query) {
...
extension MemoryQueryProperty on QueryBuilder<Memory, Memory, QQueryProperty> {
  ...
  QueryBuilder<Memory, String, QQueryOperations> notesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'notes');
    });
  }

  QueryBuilder<Memory, List<String>, QQueryOperations> photoPathsProperty() {
    return QueryBuilder.apply(this, (query) {
